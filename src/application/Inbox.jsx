					...
					<div className="row">
						<div className="col-lg-3 col-md-4">
							<div className="compose-btn">
								<a href="#" className="btn btn-primary btn-block w-100">
								Compose
								</a>
							</div>
										...
										<div className="row">
											<div className="col top-action-left">
												<div className="float-start">
													...
													<div className="btn-group dropdown-action me-1 mail-search">
											...
											<div className="col-auto top-action-right">
												<div className="text-end">
													<button type="button" title="Refresh" data-bs-toggle="tooltip" className="btn btn-white d-none d-md-inline-block me-1"><i className="fas fa-sync-alt"></i></button>
